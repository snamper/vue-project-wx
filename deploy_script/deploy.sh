...
tool_backup "sourcecode_h5_pc_${DEPLOY_ENV}" ${HOST} ${DEPLOY_DIR} ${BACKUP_DIR} ${DEPLOY_ENV}

tool_deploy ${PROJ_DIR} ${PROJ_DIR}/dist.tar.gz ${HOST} ${DEPLOY_DIR} ${TEMP_DIR} ${DEPLOY_ENV}
