...
<template>
    <div class="statistics-course">
        ...
        <div>
            ...
            <!--</div>-->
            <!--</div>-->
            <div class='terrace flex' :class='{"filter": searchBoxStatus}'>
            ...
            <div class='top-10'>
                ...
                <div class='list' :class='{"filter": searchBoxStatus}'>
                    ...
                    <div class='item flex' v-for='(item,$index) in bookList.dataList' @click = "goDetail(item)">
                        ...
                        <div class='uv sd' v-text='item.pv + "/" +item.uv'></div>
    ...
    export default {
        ...
        methods: {
            ...
            getBookData(){
                ...
                self.loadData = true;
                self.bookList=self.$list('bookList',function () {
                    loading.show('加载中...')
