        ...
        <div v-if='loadData&& configList.length!=0'>
            <header>
                <div class='brand'>
                    ...
                    <div class='left color-gray2 font-19' v-text='title.brand'></div>
                </div>
                <div class='type color-gray9 font-13' v-text='title.brand+" "+title.models'></div>
            </header>
            <section>
                <ul>
            ...
            <footer>
                <div class='back flex' @click='back()'>
                    <span class='font-11'>回到保养推荐</span><i class='iconfont icon-go font-14'></i>
                </div>
            </footer>
        </div>
