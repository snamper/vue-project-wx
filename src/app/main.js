...
function app_bootstrap(code) {
    ...
    wxsdk.ready(function () {
        ...
        wxsdk.onMenuShareAppMessage({
            title: '壳牌|保养助手2.0', // 分享标题
            desc: '壳牌|保养助手2.0', // 分享描述
            link: 'https://upkeep.vchangyi.com/h5/index.html#/maintenance/maintenance-home', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
            imgUrl: 'https://upkeep.vchangyi.com/shell.png', // 分享图标
